...
export class Keys
{
    ...
    static readonly A_KEY:number = 65;
    static readonly S_KEY:number = 83;
    static readonly W_KEY:number = 67;
    static readonly D_KEY:number = 68;
    static readonly ARROW_UP_KEY:number = 38;
